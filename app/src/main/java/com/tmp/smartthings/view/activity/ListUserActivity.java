...
public class ListUserActivity extends AppCompatActivity {
    ...
    private static final String TAG = ListUserActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ListUserActivity.this, DeviceControlActivity.class);
        ...
        mFabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ListUserActivity.this, ScanDeviceActivity.class);
                startActivity(intent);
            }
        });
    }
